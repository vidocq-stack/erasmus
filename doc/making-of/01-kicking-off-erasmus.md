# Kicking off Erasmus: from an empty reactor to a working validator

*Part 1 of the [Erasmus making-of series](../../MAKING-OF.md). Covers the tooling detour, governance,
cloning the workspace, the first two prompts, and milestones M0 + M1.*
...
Next up: [M2 — the rest of the built-in constraints, message interpolation, and custom
constraint authoring](02-full-constraint-set-and-interpolation.md).
