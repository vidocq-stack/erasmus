...
| The 21 `jakarta.validation.constraints.*` annotations | identical
...
* **XML constraint mapping** (`validation.xml` constraint declarations) — under evaluation, demand-driven.
